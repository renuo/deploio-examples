...
nctl get postgresdatabase rails-active-storage-db --print-connection-string
...
nctl get bucketuser rails-active-storage-bucketuser --print-credentials
nctl update app rails-active-storage --env="\
  S3_ACCESS_KEY={ACCESS_KEY};\
  S3_SECRET_KEY={SECRET_KEY};\
  S3_ENDPOINT=https://es34.objects.nineapis.ch;\
  S3_BUCKET=rails-active-storage-bucket"
...
nctl update bucket rails-active-storage-bucket \
  --cors origins=https://rails-active-storage.21ddead.deploio.app \
